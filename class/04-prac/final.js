...
// ////////////////////////////////////////////////////////////////////////////////
function changeFocus1(){                                                             //휴대폰번호 입력하면 다음으로 커서이동
...
function checkValidation(){                                                                         //입력값에 빈칸이 없을때 회원가입 버튼 활성화시키는 함수
    ...
    if (email!=="" && name!=="" && pw1!=="" && pw2!=="" && phone1!=="" && phone2!=="" && phone3.length=="4"){

    document.getElementById("auth_button").disabled = false;
    document.getElementById("auth_button").setAttribute("style","background-color:white")

    }else{

    document.getElementById("auth_button").disabled = true;
    document.getElementById("auth_button").setAttribute("style","background-color:none")
